...
const adminLinks = [
  ...
  { href: "/admin/freshness", label: "Freshness", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
  { href: "/admin/operations", label: "Operations", icon: "M4 6h16M4 12h16M4 18h16" },
  ...
  { href: "/admin/ticket-clicks", label: "Ticket Clicks", icon: "M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136 7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122" },
];
