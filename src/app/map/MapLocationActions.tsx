  ...
  return (
    <div className="mb-6 rounded-xl border border-zinc-800 bg-brand-surface p-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-sm font-medium text-white">Jump back to your home scene</p>
          <p className="text-sm text-zinc-500 mt-1">
            Keep the venue map anchored to the city you browse most.
          </p>
        </div>
        <div className="flex flex-wrap gap-2 text-sm">
          {savedLocation && !currentMatchesSaved && (
            ...
            >
              Open {formatPreferredLocation(savedLocation)}
            </Link>
          )}
          {savedLocation && (
            <Link
            ...
            >
              See shows in {savedLocation.city}
            </Link>
          )}
