  ...
  return (
    <main className="min-h-screen">
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
        ...
        <div className="h-9 w-80 bg-zinc-700 rounded animate-pulse mb-4" />
        <div className="h-5 w-48 bg-zinc-800 rounded animate-pulse mb-8" />
        <div className="h-48 rounded-lg bg-brand-charcoal/50 border border-zinc-800 animate-pulse mb-8" />
