...
export default function ComedianError({
  error,
  reset,
}: {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4">
      <div className="text-center max-w-md">
        <h1 className="text-2xl font-bold text-white mb-2">Comedian not found</h1>
        <p className="text-zinc-400 mb-8">
          {error.message || "This comedian may have been removed or the link is invalid."}
        </p>
