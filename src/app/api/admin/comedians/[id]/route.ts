...
export async function GET(
  ...
  try {
    ...
    logger.requestError(_request, "Failed to get comedian", err);
...
export async function PATCH(
  ...
  try {
    ...
    logger.requestError(request, "Failed to update comedian", err);
    return NextResponse.json({ error: "Internal server error" }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    logger.requestError(_request, "Failed to delete comedian", err);
    return NextResponse.json({ error: "Internal server error" }, { status: 500 });
  }
}
