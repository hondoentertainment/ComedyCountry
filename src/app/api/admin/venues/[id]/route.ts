...
export async function GET(
  ...
  try {
    ...
    logger.requestError(request, "Failed to get venue", err);
...
export async function PATCH(
  ...
  try {
    ...
    logger.requestError(request, "Failed to update venue", err);
    return NextResponse.json({ error: "Internal server error" }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    logger.requestError(request, "Failed to delete venue", err);
    return NextResponse.json({ error: "Internal server error" }, { status: 500 });
  }
}
